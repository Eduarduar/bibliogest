    ...
    <div class="flex overflow-hidden h-screen">
        ...
        <aside id="sidebar" class="bg-[#ffe6c8] text-[#e6942c] text-xl font-bold fixed inset-y-0 left-0 z-50 w-64 shadow-md transform -translate-x-full transition-transform duration-300 md:relative md:translate-x-0 ">
            ...
            <nav class="flex flex-col p-4 space-y-2">
                ...
                <a href="/dashboard/prestamos" class="flex items-center px-4 py-2 rounded transition-all transform hover:scale-110 hover:ease-in-out <?= (strpos($url, 'prestamos') !== false) ? 'bg-[#fff5dd] text-[#e6942c]' : 'hover:bg-[#e6942c] hover:text-[#ffe6c8]' ?>"><i class="mr-2 bi bi-gear"></i> Préstamos</a>
                <a href="/dashboard/categorias" class="flex items-center px-4 py-2 rounded transition-all transform hover:scale-110 hover:ease-in-out <?= (strpos($url, 'categorias') !== false) ? 'bg-[#fff5dd] text-[#e6942c]' : 'hover:bg-[#e6942c] hover:text-[#ffe6c8]' ?>"><i class="mr-2 bi bi-bar-chart-line"></i> Categorías</a>
